...
import 'package:barterit_app/edititemscreen.dart';
...
import 'package:barterit_app/newitemscreen.dart';
...
class _ItemListingScreenState extends State<ItemListingScreen> {
  ...
  void deleteItem(int index) {
    http.post(Uri.parse("${MyConfig().SERVER}/barterlt_app/php/delete_item.php"),
        body: {
